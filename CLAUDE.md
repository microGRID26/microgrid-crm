...
- `components/help/` — Help Center component architecture:
  ...
  - `topics/all-topics.ts` — barrel import aggregating all 52 topics from 12 category files
