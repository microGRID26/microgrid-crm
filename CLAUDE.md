...
- `components/help/` — Help Center component architecture:
  ...
  - `topics/all-topics.ts` — barrel import aggregating all 74 topics from 12 category files
