...
- `components/admin/` — 24 admin section components including `CustomFieldsManager.tsx`, `CommissionRatesManager.tsx` (see [File Consolidation](#file-consolidation-complete) section)
...
- **Auth-only**: `/command`, `/queue`, `/pipeline`, `/schedule`, `/crew`, `/mobile/*`, `/commissions`, `/earnings` — any authenticated user
