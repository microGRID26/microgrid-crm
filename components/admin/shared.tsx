...
export type SidebarItem = { id: Module; label: string; icon: React.ReactNode; desc: string }

// ── Admin sidebar items (admin+ access) ──────────────────────────────────────
...
export const ADMIN_SIDEBAR_ITEMS: SidebarItem[] = [
  ...
  {
    id: 'email_onboarding' as Module, label: 'Email Onboarding', desc: '30-day training series',
    icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>,
  },
  {
    id: 'custom_fields' as Module, label: 'Custom Fields', desc: 'Project custom fields',
  ...
  {
    id: 'commissions' as Module, label: 'Commission Rates', desc: 'Per-watt, adder, referral',
    icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
  },
  {
    id: 'engineering_config' as Module, label: 'Engineering Config', desc: 'Auto-routing & design fee',
  ...
  },
  {
    ...
    icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8V7m0 8v1m6-5a6 6 0 11-12 0 6 6 0 0112 0z" /></svg>,
  },
  {
    id: 'pay_distribution' as Module, label: 'Pay Distribution', desc: 'Override split percentages',
...
export const SYSTEM_SIDEBAR_ITEMS: SidebarItem[] = [
  ...
  {
    id: 'calendar_sync' as Module, label: 'Calendar Sync', desc: 'Google Calendar integration',
    icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>,
  },
  {
    id: 'edge_integration' as Module, label: 'EDGE Integration', desc: 'MicroGRID ↔ EDGE sync',
...
export const SIDEBAR_ITEMS: SidebarItem[] = [...ADMIN_SIDEBAR_ITEMS, ...SYSTEM_SIDEBAR_ITEMS]
